    ...
    public class ValuesController : ApiController
    {
        ...
        public dynamic Post([System.Web.Http.FromBody]WebhookRequest value)
        {
            ...
            var response = new WebhookResponse
            {
                ...
                //},
                //Source = "Dialogflow"
                FulfillmentText = "tjenis"
            };
            dynamic test = new JObject();
            test.FulfillmentText = "tjenis";
            test.FulfillmentMessages = "tjenis";
            string stringTest = "{ 'FulfillmentText': 'Tjenis', 'FulfillmentMessages': 'Tjenis'}";
            //response.Payload = value.QueryResult.WebhookPayload; 
            var json = JsonConvert.SerializeObject(stringTest);
